...
export class EditableCardDto extends EditableShapeDto{
  ...
  constructor(id, type, center: GachiPointDto, isGrouped, parentEdtGroupId, width, height, borderColor, borderWidth, fillColor, opacity, linkPortsDto: Array<LinkPortDto>, textContent, rawTextContent, textStyle, borderRadius: number, tagList: Array<any>) {
